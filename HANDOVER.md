...
- **Ultima versione deployata**: 2026-06-13 — UUID esatto: verificare con
  `npx wrangler deployments list` (il valore in HANDOVER.md precedente
  `89794c28` era un git commit hash, non un deployment UUID Cloudflare)
